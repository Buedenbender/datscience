...
especially because it is such a repetitive task, and I always believed that there has to be an easy solution for this in R. Recently I discovered the `table1::table1()` function, which made
life much easier. I advanced the example given by Benjamin Rich and combined it
